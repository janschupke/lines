...
describe('PlayerNameInput', () => {
  ...
  it('renders modal when isOpen is true', () => {
    ...
    expect(screen.getByText('Enter your name to save your achievement:')).toBeInTheDocument();
  });
  ...
  it('shows validation error for empty input', () => {
    ...
    expect(screen.getByText('Please enter a valid name (not just spaces)')).toBeInTheDocument();
  ...
  it('resets validation state when user starts typing again', () => {
    ...
    expect(screen.queryByText('Please enter a valid name (not just spaces)')).not.toBeInTheDocument();
  });
