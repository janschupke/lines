...
describe("handleMoveCompletion", () => {
  ...
  it("moves ball correctly", () => {
    ...
    const result = handleMoveCompletion(boardWithBall, 0, 0, 1, 1);
  ...
  it("handles move to cell with incoming ball", () => {
    ...
    const result = handleMoveCompletion(boardWithBalls, 0, 0, 1, 1);
  ...
  it("preserves other incoming balls when stepping on one", () => {
    ...
    const result = handleMoveCompletion(boardWithBalls, 0, 0, 2, 2);
