...
describe("GamePhaseManager", () => {
  ...
  describe("validateMove", () => {
    it("validates valid moves correctly", () => {
      ...
      expect(GamePhaseManager.validateMove(boardWithBall, 0, 0, 1, 1)).toBe(
        true,
      );
    });
    ...
    it("rejects moves to same cell", () => {
      ...
      expect(GamePhaseManager.validateMove(boardWithBall, 0, 0, 0, 0)).toBe(
        false,
      );
    });
    ...
    it("rejects moves to occupied cell", () => {
      ...
      expect(GamePhaseManager.validateMove(boardWithBalls, 0, 0, 1, 1)).toBe(
        false,
      );
    });
  });
  ...
  describe("handleIncomingBallConversion", () => {
    it("converts incoming balls to real balls", () => {
      ...
      const result =
        GamePhaseManager.handleIncomingBallConversion(boardWithIncoming);
    ...
    it("places fewer balls when limited space available", () => {
      ...
      const result =
        GamePhaseManager.handleIncomingBallConversion(almostFullBoard);
  ...
  describe("Integration: Line removal preserves incoming balls", () => {
    ...
    it("automatic ball placement does not trigger line removal", () => {
      ...
      const conversionResult =
        GamePhaseManager.handleIncomingBallConversion(testBoard);
